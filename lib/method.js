...
export async function getLessonData(levelSlug, lessonSlug, learningLang) {
	...
	if (jsonExists) {
		console.log(`[getLessonData] Loading lesson from JSON: ${learningLang}/${levelSlug}/${lessonSlug}`)
	...
	console.log(`[getLessonData] ❌ ERROR: Lesson not found in JSON: ${learningLang}/${levelSlug}/${lessonSlug}`)
	console.error(`Lesson content must be in JSON file: data/method/${learningLang}/${levelSlug}/${lessonSlug}.json`)
