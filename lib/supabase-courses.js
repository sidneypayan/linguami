...
// Fallback chain: COURSES -> PROD -> regular (for backwards compatibility)
const COURSES_DB_URL = process.env.SUPABASE_COURSES_URL || process.env.NEXT_PUBLIC_SUPABASE_PROD_URL || process.env.NEXT_PUBLIC_SUPABASE_URL
const COURSES_DB_KEY = process.env.SUPABASE_COURSES_SERVICE_KEY || process.env.SUPABASE_PROD_SERVICE_ROLE_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY
