 ...
 * DEPRECATED - Goal bonuses are no longer automatically awarded
 */
// Function removed - no automatic gold rewards for goals anymore
...
export async function getGoals(userId) {
	...
	try {
		...
		// Note: Daily goal rewards removed - no automatic gold bonus
		...
		if (weeklyGoal) {
			...
			// Note: Weekly goal rewards removed - no automatic gold bonus
		}
		...
		if (monthlyGoal) {
			...
			// Note: Monthly goal rewards removed - no automatic gold bonus
		}
