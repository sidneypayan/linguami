							...
							<Link href="/materials">
								<Button
									...
									className={cn(
										...
										"shadow-[0_8px_30px_rgba(139,92,246,0.4),0_0_20px_rgba(6,182,212,0.3)] dark:shadow-none",
										"hover:shadow-[0_12px_40px_rgba(139,92,246,0.6),0_0_30px_rgba(6,182,212,0.4)] dark:hover:shadow-none",
