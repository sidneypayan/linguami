...
// ====================
const lesson9BlocksEn = [
  { type: 'mainTitle', text: 'First Group Verbs (-ать/-ять)' },
  { type: 'subtitle', text: 'Present Tense Conjugation - Group 1' },
  {
    type: 'quickSummary',
    title: 'Key Points',
    keyForms: [
      { form: 'читать → я читаю', translation: 'to read → I read' },
      { form: 'знать → ты знаешь', translation: 'to know → you know' },
      { form: 'делать → он делает', translation: 'to do → he does' },
      { form: '-ю, -ешь, -ет, -ем, -ете, -ют', translation: 'Present tense endings' }
    ]
  },
  { type: 'title', text: 'First Conjugation Pattern' },
  {
    type: 'paragraph',
    text: 'Russian verbs are divided into two conjugation groups. The <strong>first group</strong> includes most verbs ending in <strong>-ать, -ять, -еть</strong>. In the present tense, they take the endings: <strong>-ю, -ешь, -ет, -ем, -ете, -ют</strong>.'
  },
  {
    type: 'conjugationTable',
    title: 'читать (to read) - Present Tense',
    rows: [
      { pronoun: 'я читаю', form: '[ya chitayu]', translation: 'I read', pronunciation: '1st person singular' },
      { pronoun: 'ты читаешь', form: '[ty chitayesh]', translation: 'you read (informal)', pronunciation: '2nd person singular' },
      { pronoun: 'он/она читает', form: '[on/ona chitayet]', translation: 'he/she reads', pronunciation: '3rd person singular' },
      { pronoun: 'мы читаем', form: '[my chitayem]', translation: 'we read', pronunciation: '1st person plural' },
      { pronoun: 'вы читаете', form: '[vy chitayete]', translation: 'you read (formal/plural)', pronunciation: '2nd person plural' },
      { pronoun: 'они читают', form: '[oni chitayut]', translation: 'they read', pronunciation: '3rd person plural' }
    ]
  },
  { type: 'title', text: 'Common First Group Verbs' },
  {
    type: 'conjugationTable',
    title: 'Essential -ать Verbs',
    rows: [
      { pronoun: 'знать', form: '[znat]', translation: 'to know', pronunciation: 'я знаю, ты знаешь, он знает' },
      { pronoun: 'делать', form: '[delat]', translation: 'to do, to make', pronunciation: 'я делаю, ты делаешь, он делает' },
      { pronoun: 'слушать', form: '[slushat]', translation: 'to listen', pronunciation: 'я слушаю, ты слушаешь' },
      { pronoun: 'думать', form: '[dumat]', translation: 'to think', pronunciation: 'я думаю, ты думаешь' },
      { pronoun: 'понимать', form: '[ponimat]', translation: 'to understand', pronunciation: 'я понимаю, ты понимаешь' },
      { pronoun: 'гулять', form: '[gulyat]', translation: 'to walk, to stroll', pronunciation: 'я гуляю, ты гуляешь' },
      { pronoun: 'работать', form: '[rabotat]', translation: 'to work', pronunciation: 'я работаю, ты работаешь' },
      { pronoun: 'играть', form: '[igrat]', translation: 'to play', pronunciation: 'я играю, ты играешь' }
    ]
  },
  { type: 'title', text: 'Full Conjugation Examples' },
  {
    type: 'usageList',
    ...
    items: [
      ...
      {
        usage: 'делать (to do, to make)',
        examples: [
          'я делаю — I do/make',
          'ты делаешь — you do/make',
          'он/она делает — he/she does/makes',
          'мы делаем — we do/make',
          'вы делаете — you do/make',
          'они делают — they do/make'
        ]
      },
      {
        usage: 'работать (to work)',
        examples: [
          'я работаю — I work',
        ...
        commonMistake: {
          wrong: 'я работает',
          correct: 'я работаю (1st person takes -ю)'
        }
      }
    ]
  },
  { type: 'title', text: 'Negative Form' },
  {
    type: 'paragraph',
    text: 'To make a verb negative in Russian, simply add <strong>не</strong> before the verb. The verb form does not change. The particle "не" is always written as a separate word.'
  },
  {
    type: 'conjugationTable',
    title: 'Negation Examples',
    rows: [
      { pronoun: 'я не знаю', form: '[ya ne znayu]', translation: 'I do not know' },
      { pronoun: 'ты не читаешь', form: '[ty ne chitayesh]', translation: 'you do not read' },
      { pronoun: 'он не работает', form: '[on ne rabotayet]', translation: 'he does not work' },
      { pronoun: 'мы не понимаем', form: '[my ne ponimayem]', translation: 'we do not understand' },
      { pronoun: 'вы не делаете', form: '[vy ne delayete]', translation: 'you do not do' },
      { pronoun: 'они не слушают', form: '[oni ne slushayut]', translation: 'they do not listen' }
    ]
  },
  {
    type: 'mistakesTable',
    title: 'Common Mistakes',
    rows: [
      { wrong: 'я читаешь', correct: 'я читаю', explanation: '1st person takes -ю, not -ешь' },
      { wrong: 'они читает', correct: 'они читают', explanation: '3rd person plural takes -ют, not -ет' },
      { wrong: 'неработаю (no space)', correct: 'не работаю (with space)', explanation: '"не" is always a separate word' },
      { wrong: 'знать → знаюю (double ю)', correct: 'знать → знаю', explanation: 'Only one ю in 1st person' }
    ]
  },
  { type: 'title', text: 'Additional Vocabulary' },
  {
    type: 'list',
    items: [
      '<strong>отвечать</strong> [otvechat] — to answer',
      '<strong>спрашивать</strong> [sprashivat] — to ask',
      '<strong>начинать</strong> [nachinat] — to begin',
      '<strong>кончать</strong> [konchat] — to finish, to end',
      '<strong>покупать</strong> [pokupat] — to buy',
      '<strong>продавать</strong> [prodavat] — to sell',
      '<strong>помогать</strong> [pomogat] — to help',
      '<strong>мешать</strong> [meshat] — to disturb, to prevent',
      '<strong>давать</strong> [davat] — to give',
      '<strong>узнавать</strong> [uznavat] — to recognize, to find out'
    ]
  },
  {
    type: 'miniDialogue',
    title: 'Complete Dialogue: Daily Activities',
    translation: '— What are you doing? — I am reading a book. And you? — I am working. Do you know where Anna is? — Yes, she is walking in the park. — And what is Pavel doing? — He is listening to music. — Do they understand Russian? — Yes, they understand well.',
    lines: [
      { speaker: 'Иван', text: 'Что ты делаешь?' },
      { speaker: 'Мария', text: 'Я читаю книгу. А ты?' },
      { speaker: 'Иван', text: 'Я работаю. Ты знаешь, где Анна?' },
      { speaker: 'Мария', text: 'Да, она гуляет в парке.' },
      { speaker: 'Иван', text: 'А что делает Павел?' },
      { speaker: 'Мария', text: 'Он слушает музыку.' },
      { speaker: 'Иван', text: 'Они понимают по-русски?' },
      { speaker: 'Мария', text: 'Да, они хорошо понимают.' }
    ]
  },
  { type: 'relatedTopics' }
];

const lesson9BlocksFr = [
  { type: 'mainTitle', text: 'Verbes du 1er groupe (-ать/-ять)' },
  { type: 'subtitle', text: 'Conjugaison au présent - Groupe 1' },
  {
    type: 'quickSummary',
    title: 'Points clés',
    keyForms: [
      { form: 'читать → я читаю', translation: 'lire → je lis' },
      { form: 'знать → ты знаешь', translation: 'savoir → tu sais' },
      { form: 'делать → он делает', translation: 'faire → il fait' },
      { form: '-ю, -ешь, -ет, -ем, -ете, -ют', translation: 'Terminaisons du présent' }
    ]
  },
  { type: 'title', text: 'Schéma de la première conjugaison' },
  {
    type: 'paragraph',
    text: 'Les verbes russes sont divisés en deux groupes de conjugaison. Le <strong>premier groupe</strong> comprend la plupart des verbes se terminant par <strong>-ать, -ять, -еть</strong>. Au présent, ils prennent les terminaisons : <strong>-ю, -ешь, -ет, -ем, -ете, -ют</strong>.'
  },
  {
    type: 'conjugationTable',
    title: 'читать (lire) - Présent',
    rows: [
      { pronoun: 'я читаю', form: '[ya chitayu]', translation: 'je lis', pronunciation: '1ère personne singulier' },
      { pronoun: 'ты читаешь', form: '[ty chitayesh]', translation: 'tu lis', pronunciation: '2ème personne singulier' },
      { pronoun: 'он/она читает', form: '[on/ona chitayet]', translation: 'il/elle lit', pronunciation: '3ème personne singulier' },
      { pronoun: 'мы читаем', form: '[my chitayem]', translation: 'nous lisons', pronunciation: '1ère personne pluriel' },
      { pronoun: 'вы читаете', form: '[vy chitayete]', translation: 'vous lisez', pronunciation: '2ème personne pluriel' },
      { pronoun: 'они читают', form: '[oni chitayut]', translation: 'ils/elles lisent', pronunciation: '3ème personne pluriel' }
    ]
  },
  { type: 'title', text: 'Verbes courants du 1er groupe' },
  {
    type: 'conjugationTable',
    title: 'Verbes essentiels en -ать',
    rows: [
      { pronoun: 'знать', form: '[znat]', translation: 'savoir', pronunciation: 'я знаю, ты знаешь, он знает' },
      { pronoun: 'делать', form: '[delat]', translation: 'faire', pronunciation: 'я делаю, ты делаешь, он делает' },
      { pronoun: 'слушать', form: '[slushat]', translation: 'écouter', pronunciation: 'я слушаю, ты слушаешь' },
      { pronoun: 'думать', form: '[dumat]', translation: 'penser', pronunciation: 'я думаю, ты думаешь' },
      { pronoun: 'понимать', form: '[ponimat]', translation: 'comprendre', pronunciation: 'я понимаю, ты понимаешь' },
      { pronoun: 'гулять', form: '[gulyat]', translation: 'se promener', pronunciation: 'я гуляю, ты гуляешь' },
      { pronoun: 'работать', form: '[rabotat]', translation: 'travailler', pronunciation: 'я работаю, ты работаешь' },
      { pronoun: 'играть', form: '[igrat]', translation: 'jouer', pronunciation: 'я играю, ты играешь' }
    ]
  },
  { type: 'title', text: 'Exemples de conjugaison complète' },
  {
    type: 'usageList',
    title: 'Trois verbes essentiels',
    items: [
      {
        usage: 'знать (savoir)',
        examples: [
      ...
      {
        usage: 'работать (travailler)',
        examples: [
          'я работаю — je travaille',
          'ты работаешь — tu travailles',
          'он/она работает — il/elle travaille',
          'мы работаем — nous travaillons',
          'вы работаете — vous travaillez',
          'они работают — ils/elles travaillent'
        ],
        commonMistake: {
          wrong: 'я работает',
          correct: 'я работаю (1ère personne prend -ю)'
        }
      }
    ]
  },
  { type: 'title', text: 'Forme négative' },
  {
    type: 'paragraph',
    text: 'Pour mettre un verbe à la forme négative en russe, il suffit d\'ajouter <strong>не</strong> avant le verbe. La forme verbale ne change pas. La particule "не" s\'écrit toujours comme un mot séparé.'
  },
  {
    type: 'conjugationTable',
    title: 'Exemples de négation',
    rows: [
      { pronoun: 'я не знаю', form: '[ya ne znayu]', translation: 'je ne sais pas' },
      { pronoun: 'ты не читаешь', form: '[ty ne chitayesh]', translation: 'tu ne lis pas' },
      { pronoun: 'он не работает', form: '[on ne rabotayet]', translation: 'il ne travaille pas' },
      { pronoun: 'мы не понимаем', form: '[my ne ponimayem]', translation: 'nous ne comprenons pas' },
      { pronoun: 'вы не делаете', form: '[vy ne delayete]', translation: 'vous ne faites pas' },
      { pronoun: 'они не слушают', form: '[oni ne slushayut]', translation: 'ils/elles n\'écoutent pas' }
    ]
  },
  {
    type: 'mistakesTable',
    title: 'Erreurs courantes',
    rows: [
      { wrong: 'я читаешь', correct: 'я читаю', explanation: '1ère personne prend -ю, pas -ешь' },
      { wrong: 'они читает', correct: 'они читают', explanation: '3ème personne pluriel prend -ют, pas -ет' },
      { wrong: 'неработаю (sans espace)', correct: 'не работаю (avec espace)', explanation: '"не" est toujours un mot séparé' },
      { wrong: 'знать → знаюю (double ю)', correct: 'знать → знаю', explanation: 'Un seul ю à la 1ère personne' }
    ]
  },
  { type: 'title', text: 'Vocabulaire supplémentaire' },
  {
    type: 'list',
    items: [
      '<strong>отвечать</strong> [otvechat] — répondre',
      '<strong>спрашивать</strong> [sprashivat] — demander',
      '<strong>начинать</strong> [nachinat] — commencer',
      '<strong>кончать</strong> [konchat] — finir, terminer',
      '<strong>покупать</strong> [pokupat] — acheter',
      '<strong>продавать</strong> [prodavat] — vendre',
      '<strong>помогать</strong> [pomogat] — aider',
      '<strong>мешать</strong> [meshat] — déranger, empêcher',
      '<strong>давать</strong> [davat] — donner',
      '<strong>узнавать</strong> [uznavat] — reconnaître, apprendre'
    ]
  },
  {
    type: 'miniDialogue',
    title: 'Dialogue complet : Activités quotidiennes',
    translation: '— Que fais-tu ? — Je lis un livre. Et toi ? — Je travaille. Tu sais où est Anna ? — Oui, elle se promène dans le parc. — Et que fait Pavel ? — Il écoute de la musique. — Est-ce qu\'ils comprennent le russe ? — Oui, ils comprennent bien.',
    lines: [
      { speaker: 'Ivan', text: 'Что ты делаешь?' },
      { speaker: 'Maria', text: 'Я читаю книгу. А ты?' },
      { speaker: 'Ivan', text: 'Я работаю. Ты знаешь, где Анна?' },
      { speaker: 'Maria', text: 'Да, она гуляет в парке.' },
      { speaker: 'Ivan', text: 'А что делает Павел?' },
      { speaker: 'Maria', text: 'Он слушает музыку.' },
      { speaker: 'Ivan', text: 'Они понимают по-русски?' },
      { speaker: 'Maria', text: 'Да, они хорошо понимают.' }
    ]
  },
  { type: 'relatedTopics' }
];

// Lessons 10-20 continue below...
...
const allLessons = [
  ...
  createLesson(9, 'First Group Verbs (-ать/-ять)', 'Verbes du 1er groupe (-ать/-ять)', 'Глаголы 1-го спряжения', lesson9BlocksEn, lesson9BlocksFr)
  // Lessons 10-20 will be added below
];
